...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_publicIssuerCertificates = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceBinary"];
		_cloudPublicIssuerCertificates = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceBinary"];
    }
