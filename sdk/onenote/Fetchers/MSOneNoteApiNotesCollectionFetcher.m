...
/**
* The implementation file for type MSOneNoteApiNotesCollectionFetcher.
*/
...
- (MSOneNoteApiNotesFetcher *)getById:(NSString *)id {
    ...
    return [[MSOneNoteApiNotesFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
