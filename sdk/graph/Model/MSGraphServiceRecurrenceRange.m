...
- (void)setTypeString:(NSString *)value {
	...
	if ([value isEqualToString:@"EndDate"]) {
		...
		_type = MSGraphService_RecurrenceRangeType_EndDate;
        [self valueChangedForInt:MSGraphService_RecurrenceRangeType_EndDate forProperty:@"Type"];
	}

	if ([value isEqualToString:@"NoEnd"]) {

		_type = MSGraphService_RecurrenceRangeType_NoEnd;
        [self valueChangedForInt:MSGraphService_RecurrenceRangeType_NoEnd forProperty:@"Type"];
	}

	if ([value isEqualToString:@"Numbered"]) {

		_type = MSGraphService_RecurrenceRangeType_Numbered;
        [self valueChangedForInt:MSGraphService_RecurrenceRangeType_Numbered forProperty:@"Type"];
	}
}
