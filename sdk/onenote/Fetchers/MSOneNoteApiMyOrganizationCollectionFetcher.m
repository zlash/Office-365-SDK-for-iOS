...
/**
* The implementation file for type MSOneNoteApiMyOrganizationCollectionFetcher.
*/
...
- (void)add:(MSOneNoteApiMyOrganization*)entity callback:(void (^)(MSOneNoteApiMyOrganization *myOrganization, MSOrcError *error))callback {
...
- (MSOneNoteApiMyOrganizationFetcher *)getById:(NSString *)id {

    return [[MSOneNoteApiMyOrganizationFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
