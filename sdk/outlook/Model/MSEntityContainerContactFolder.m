...
/**
* The implementation file for type MSEntityContainerContactFolder.
*/

@implementation MSEntityContainerContactFolder	
...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_childFolders = [[NSMutableArray alloc] initWithCollectionType:@"MSEntityContainerContactFolder"];
    }
