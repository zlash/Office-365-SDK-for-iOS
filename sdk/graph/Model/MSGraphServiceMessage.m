...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_bccRecipients = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceRecipient"];
		_replyTo = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceRecipient"];
...
- (void)setUniqueBody:(MSGraphServiceItemBody *) uniqueBody {
