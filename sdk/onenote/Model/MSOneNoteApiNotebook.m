...
- (void)setIsDefault:(BOOL ) isDefault {
	...
	if ([value isEqualToString:@"Owner"]) {	
        ...
        [self valueChangedForInt:MSOneNoteApi_UserRole_Owner forProperty:@"userRole"];
	}

	if ([value isEqualToString:@"Contributor"]) {	

		_userRole  = MSOneNoteApi_UserRole_Contributor;
        [self valueChangedForInt:MSOneNoteApi_UserRole_Contributor forProperty:@"userRole"];
	}

	if ([value isEqualToString:@"Reader"]) {	

		_userRole  = MSOneNoteApi_UserRole_Reader;
        [self valueChangedForInt:MSOneNoteApi_UserRole_Reader forProperty:@"userRole"];
	}

	if ([value isEqualToString:@"None"]) {	

		_userRole  = MSOneNoteApi_UserRole_None;
        [self valueChangedForInt:MSOneNoteApi_UserRole_None forProperty:@"userRole"];
	}
}
...
- (void)setLinks:(MSOneNoteApiNotebookLinks *) links {
    _links = links;
