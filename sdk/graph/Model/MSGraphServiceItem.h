...
@interface MSGraphServiceItem : MSOrcBaseEntity

@property (copy, nonatomic, readwrite, getter=createdBy, setter=setCreatedBy:) MSGraphServiceIdentitySet *createdBy;
...
@property (copy, nonatomic, readwrite, getter=lastModifiedBy, setter=setLastModifiedBy:) MSGraphServiceIdentitySet *lastModifiedBy;
@property (copy, nonatomic, readwrite, getter=name, setter=setName:) NSString *name;
@property (copy, nonatomic, readwrite, getter=parentReference, setter=setParentReference:) MSGraphServiceItemReference *parentReference;
...
@property (copy, nonatomic, readwrite, getter=createdByUser, setter=setCreatedByUser:) MSGraphServiceUser *createdByUser;
@property (copy, nonatomic, readwrite, getter=lastModifiedByUser, setter=setLastModifiedByUser:) MSGraphServiceUser *lastModifiedByUser;
