...
@implementation MSEntityContainerGeoCoordinates	
...
- (void)setAltitude:(MSEntityContainerDouble *) altitude {
    _altitude = altitude;
	[self valueChanged:altitude forProperty:@"Altitude"];
}
    
- (void)setLatitude:(MSEntityContainerDouble *) latitude {
    _latitude = latitude;
	[self valueChanged:latitude forProperty:@"Latitude"];
}
    
- (void)setLongitude:(MSEntityContainerDouble *) longitude {
    _longitude = longitude;
	[self valueChanged:longitude forProperty:@"Longitude"];
}
    
- (void)setAccuracy:(MSEntityContainerDouble *) accuracy {
    _accuracy = accuracy;
	[self valueChanged:accuracy forProperty:@"Accuracy"];
}
    
- (void)setAltitudeAccuracy:(MSEntityContainerDouble *) altitudeAccuracy {
