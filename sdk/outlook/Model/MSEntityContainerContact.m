...
/**
* The implementation file for type MSEntityContainerContact.
*/

@implementation MSEntityContainerContact	
...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_emailAddresses = [[NSMutableArray alloc] initWithCollectionType:@"MSEntityContainerEmailAddress"];
		_imAddresses = [[NSMutableArray alloc] initWithCollectionType:@"MSEntityContainerString"];
		_homePhones = [[NSMutableArray alloc] initWithCollectionType:@"MSEntityContainerString"];
		_businessPhones = [[NSMutableArray alloc] initWithCollectionType:@"MSEntityContainerString"];
    }
...
- (void)setHomeAddress:(MSEntityContainerPhysicalAddress *) homeAddress {
    _homeAddress = homeAddress;
	[self valueChanged:homeAddress forProperty:@"HomeAddress"];
}
    
- (void)setBusinessAddress:(MSEntityContainerPhysicalAddress *) businessAddress {
    _businessAddress = businessAddress;
	[self valueChanged:businessAddress forProperty:@"BusinessAddress"];
}
    
- (void)setOtherAddress:(MSEntityContainerPhysicalAddress *) otherAddress {
