...
- (void)setContentTypeString:(NSString *)value {
	...
	if ([value isEqualToString:@"Text"]) {
		...
		_contentType = MSGraphService_BodyType_Text;
        [self valueChangedForInt:MSGraphService_BodyType_Text forProperty:@"ContentType"];
	}

	if ([value isEqualToString:@"HTML"]) {

		_contentType = MSGraphService_BodyType_HTML;
        [self valueChangedForInt:MSGraphService_BodyType_HTML forProperty:@"ContentType"];
	}
}
