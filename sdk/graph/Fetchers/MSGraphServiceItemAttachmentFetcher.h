...
- (void)update:(MSGraphServiceItemAttachment *)itemAttachment callback:(void(^)(MSGraphServiceItemAttachment *itemAttachment, MSOrcError *error))callback;
...
@property (retain, nonatomic, readonly, getter=item) MSGraphServiceOutlookItemFetcher *item;
