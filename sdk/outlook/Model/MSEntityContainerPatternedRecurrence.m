...
@implementation MSEntityContainerPatternedRecurrence	
...
- (void)setPattern:(MSEntityContainerRecurrencePattern *) pattern {
    _pattern = pattern;
	[self valueChanged:pattern forProperty:@"Pattern"];
}
    
- (void)setRange:(MSEntityContainerRecurrenceRange *) range {
    _range = range;
