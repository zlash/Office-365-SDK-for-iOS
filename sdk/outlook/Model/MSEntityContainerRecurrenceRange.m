...
@implementation MSEntityContainerRecurrenceRange	
...
- (void)setTypeString:(NSString *)value {
	...
	if ([value isEqualToString:@"EndDate"]) {
		...
		_type = MSEntityContainer_RecurrenceRangeType_EndDate;
        [self valueChangedForInt:MSEntityContainer_RecurrenceRangeType_EndDate forProperty:@"Type"];
	}

	if ([value isEqualToString:@"NoEnd"]) {

		_type = MSEntityContainer_RecurrenceRangeType_NoEnd;
        [self valueChangedForInt:MSEntityContainer_RecurrenceRangeType_NoEnd forProperty:@"Type"];
	}

	if ([value isEqualToString:@"Numbered"]) {

		_type = MSEntityContainer_RecurrenceRangeType_Numbered;
        [self valueChangedForInt:MSEntityContainer_RecurrenceRangeType_Numbered forProperty:@"Type"];
	}
}
