...
/**
* The implementation file for type MSEntityContainerFolderOperations.
*/

@implementation MSEntityContainerFolderOperations
...
- (void)copyWithDestinationId:(NSString *)destinationId callback:(void (^)(MSEntityContainerFolder *folder, MSOrcError *error))callback {
	...
	return [self copyRawWithDestinationId:destinationIdString callback:^(NSString *returnValue, MSOrcError *e) {
	   ...
	   if (e == nil) {
			...
			MSEntityContainerFolder * result = (MSEntityContainerFolder *)[super.resolver.jsonSerializer deserialize:[returnValue dataUsingEncoding:NSUTF8StringEncoding] asClass:[MSEntityContainerFolder class]];
            callback(result, e);
        } 
		else {
...
- (void)moveWithDestinationId:(NSString *)destinationId callback:(void (^)(MSEntityContainerFolder *folder, MSOrcError *error))callback {
