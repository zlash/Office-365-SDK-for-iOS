...
/**
* The implementation file for type MSOneNoteApiGroupCollectionFetcher.
*/
...
- (void)add:(MSOneNoteApiGroup*)entity callback:(void (^)(MSOneNoteApiGroup *group, MSOrcError *error))callback {
...
- (MSOneNoteApiGroupFetcher *)getById:(NSString *)id {

    return [[MSOneNoteApiGroupFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
