...
/**
* The implementation file for type MSEntityContainerMessageOperations.
*/

@implementation MSEntityContainerMessageOperations
...
- (void)copyWithDestinationId:(NSString *)destinationId callback:(void (^)(MSEntityContainerMessage *message, MSOrcError *error))callback {
	...
	return [self copyRawWithDestinationId:destinationIdString callback:^(NSString *returnValue, MSOrcError *e) {
	   ...
	   if (e == nil) {
			...
			MSEntityContainerMessage * result = (MSEntityContainerMessage *)[super.resolver.jsonSerializer deserialize:[returnValue dataUsingEncoding:NSUTF8StringEncoding] asClass:[MSEntityContainerMessage class]];
            callback(result, e);
        } 
		else {
...
- (void)moveWithDestinationId:(NSString *)destinationId callback:(void (^)(MSEntityContainerMessage *message, MSOrcError *error))callback {
...
- (void)createReplyWithCallback:(void (^)(MSEntityContainerMessage *message, MSOrcError *error))callback {
...
- (void)createReplyAllWithCallback:(void (^)(MSEntityContainerMessage *message, MSOrcError *error))callback {
...
- (void)createForwardWithCallback:(void (^)(MSEntityContainerMessage *message, MSOrcError *error))callback {
