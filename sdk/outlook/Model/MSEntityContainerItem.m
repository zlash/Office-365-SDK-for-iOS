...
/**
* The implementation file for type MSEntityContainerItem.
*/

@implementation MSEntityContainerItem	
...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_categories = [[NSMutableArray alloc] initWithCollectionType:@"MSEntityContainerString"];
    }
