...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_children = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceItem"];
    }

	return self;
}

- (void)setCreatedBy:(MSGraphServiceIdentitySet *) createdBy {
...
- (void)setLastModifiedBy:(MSGraphServiceIdentitySet *) lastModifiedBy {
...
- (void)setParentReference:(MSGraphServiceItemReference *) parentReference {
...
- (void)setCreatedByUser:(MSGraphServiceUser *) createdByUser {
    _createdByUser = createdByUser;
	[self valueChanged:createdByUser forProperty:@"createdByUser"];
}
    
- (void)setLastModifiedByUser:(MSGraphServiceUser *) lastModifiedByUser {
