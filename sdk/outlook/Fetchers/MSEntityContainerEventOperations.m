...
/**
* The implementation file for type MSEntityContainerEventOperations.
*/

@implementation MSEntityContainerEventOperations
...
- (void)acceptRawWithComment:(NSString *) comment sendResponse:(NSString *) sendResponse callback:(void(^)(NSString *returnValue, MSOrcError *error))callback {
	...
	NSArray *parameters = [[NSArray alloc] initWithObjects:
                          ...
                          [[NSDictionary alloc] initWithObjectsAndKeys :sendResponse,@"SendResponse", nil], nil];
