...
@class MSEntityContainerEmailAddress;
@class MSEntityContainerPhysicalAddress;
...
@interface MSEntityContainerContact : MSEntityContainerItem
...
@property (copy, nonatomic, readwrite, getter=homeAddress, setter=setHomeAddress:) MSEntityContainerPhysicalAddress *HomeAddress;
@property (copy, nonatomic, readwrite, getter=businessAddress, setter=setBusinessAddress:) MSEntityContainerPhysicalAddress *BusinessAddress;
@property (copy, nonatomic, readwrite, getter=otherAddress, setter=setOtherAddress:) MSEntityContainerPhysicalAddress *OtherAddress;
