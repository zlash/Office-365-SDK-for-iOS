...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_servicePlans = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceServicePlanInfo"];
    }
...
- (void)setPrepaidUnits:(MSGraphServiceLicenseUnitsDetail *) prepaidUnits {
