...
/**
* The implementation file for type MSGraphServicePostCollectionFetcher.
*/
...
- (void)add:(MSGraphServicePost*)entity callback:(void (^)(MSGraphServicePost *post, MSOrcError *error))callback {
...
- (MSGraphServicePostFetcher *)getById:(NSString *)id {

    return [[MSGraphServicePostFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
