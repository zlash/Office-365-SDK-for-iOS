...
/**
* The implementation file for type MSOneNoteApiMyOrganization.
*/
...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_siteCollections = [[NSMutableArray alloc] initWithCollectionType:@"MSOneNoteApiSiteCollection"];
		_groups = [[NSMutableArray alloc] initWithCollectionType:@"MSOneNoteApiGroup"];
    }
...
- (void)setGroups:(NSMutableArray *) groups {
    _groups = groups;
	[self valueChanged:groups forProperty:@"groups"];
}
