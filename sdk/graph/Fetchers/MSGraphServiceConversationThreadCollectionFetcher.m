...
/**
* The implementation file for type MSGraphServiceConversationThreadCollectionFetcher.
*/
...
- (MSGraphServiceConversationThreadFetcher *)getById:(NSString *)id {
    ...
    return [[MSGraphServiceConversationThreadFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
