...
@implementation MSEntityContainerLocation	
...
- (void)setAddress:(MSEntityContainerPhysicalAddress *) address {
    _address = address;
	[self valueChanged:address forProperty:@"Address"];
}
    
- (void)setCoordinates:(MSEntityContainerGeoCoordinates *) coordinates {
