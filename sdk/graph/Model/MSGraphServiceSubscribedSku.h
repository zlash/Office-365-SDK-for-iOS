...
@interface MSGraphServiceSubscribedSku : MSOrcBaseEntity
...
@property (copy, nonatomic, readwrite, getter=prepaidUnits, setter=setPrepaidUnits:) MSGraphServiceLicenseUnitsDetail *prepaidUnits;
