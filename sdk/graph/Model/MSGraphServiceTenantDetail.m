...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_marketingNotificationEmails = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceString"];
		...
		_securityComplianceNotificationMails = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceString"];
		_securityComplianceNotificationPhones = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceString"];
		_technicalNotificationMails = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceString"];
		_verifiedDomains = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceVerifiedDomain"];
    }
