...
@interface MSOneNoteApiSectionGroup : MSOrcBaseEntity
...
@property (copy, nonatomic, readwrite, getter=parentSectionGroup, setter=setParentSectionGroup:) MSOneNoteApiSectionGroup *parentSectionGroup;
