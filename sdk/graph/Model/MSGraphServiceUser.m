...
@synthesize TrendingAround = _trendingAround;
@synthesize WorkingWith = _workingWith;
@synthesize JoinedGroups = _joinedGroups;
...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_assignedLicenses = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceAssignedLicense"];
		_assignedPlans = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceAssignedPlan"];
		_otherMails = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceString"];
		_provisionedPlans = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceProvisionedPlan"];
		...
		_interests = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceString"];
		_pastProjects = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceString"];
		_responsibilities = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceString"];
		_schools = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceString"];
		_skills = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceString"];
		...
		_ownedDevices = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceDirectoryObject"];
		_registeredDevices = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceDirectoryObject"];
		_directReports = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceDirectoryObject"];
		...
		_messages = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceMessage"];
		_calendars = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceCalendar"];
		_calendarGroups = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceCalendarGroup"];
		...
		_userPhotos = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServicePhoto"];
		_trendingAround = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceFile"];
		_workingWith = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceUser"];
		_joinedGroups = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceGroup"];
...
- (void)setPasswordProfile:(MSGraphServicePasswordProfile *) passwordProfile {
...
- (void)setManager:(MSGraphServiceDirectoryObject *) manager {
    _manager = manager;
...
- (void)setUserPhoto:(MSGraphServicePhoto *) userPhoto {
...
- (void)setTrendingAround:(NSMutableArray *) trendingAround {
    _trendingAround = trendingAround;
	[self valueChanged:trendingAround forProperty:@"TrendingAround"];
}
    
- (void)setWorkingWith:(NSMutableArray *) workingWith {
    _workingWith = workingWith;
	[self valueChanged:workingWith forProperty:@"WorkingWith"];
}
    
- (void)setJoinedGroups:(NSMutableArray *) joinedGroups {
    _joinedGroups = joinedGroups;
	[self valueChanged:joinedGroups forProperty:@"JoinedGroups"];
}
    
- (void)setDrive:(MSGraphServiceDrive *) drive {
    _drive = drive;
