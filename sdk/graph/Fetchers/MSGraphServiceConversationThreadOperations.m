...
/**
* The implementation file for type MSGraphServiceConversationThreadOperations.
*/
...
- (void)replyWithPost:(MSGraphServicePost *)post callback:(void (^)(int returnValue, MSOrcError *error))callback {
...
- (void)replyRawWithPost:(NSString *) post callback:(void(^)(NSString *returnValue, MSOrcError *error))callback {

	id<MSOrcRequest> request = [super.resolver createOrcRequest];
	NSArray *parameters = [[NSArray alloc] initWithObjects:
                          [[NSDictionary alloc] initWithObjectsAndKeys :post,@"Post", nil], nil];
