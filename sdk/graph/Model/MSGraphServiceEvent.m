...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_attendees = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceAttendee"];
		_attachments = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceAttachment"];
		_instances = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphServiceEvent"];
    }
...
- (void)setBodyPreview:(NSString *) bodyPreview {
	...
	if ([value isEqualToString:@"Low"]) {	
        ...
        [self valueChangedForInt:MSGraphService_Importance_Low forProperty:@"Importance"];
	}

	if ([value isEqualToString:@"Normal"]) {	

		_importance  = MSGraphService_Importance_Normal;
        [self valueChangedForInt:MSGraphService_Importance_Normal forProperty:@"Importance"];
	}

	if ([value isEqualToString:@"High"]) {	

		_importance  = MSGraphService_Importance_High;
        [self valueChangedForInt:MSGraphService_Importance_High forProperty:@"Importance"];
	}
}
...
- (void)setLocation:(MSGraphServiceLocation *) location {
    _location = location;
	...
	if ([value isEqualToString:@"Free"]) {	
        ...
        [self valueChangedForInt:MSGraphService_FreeBusyStatus_Free forProperty:@"ShowAs"];
	}

	if ([value isEqualToString:@"Tentative"]) {	

		_showAs  = MSGraphService_FreeBusyStatus_Tentative;
        [self valueChangedForInt:MSGraphService_FreeBusyStatus_Tentative forProperty:@"ShowAs"];
	}

	if ([value isEqualToString:@"Busy"]) {	

		_showAs  = MSGraphService_FreeBusyStatus_Busy;
        [self valueChangedForInt:MSGraphService_FreeBusyStatus_Busy forProperty:@"ShowAs"];
	}

	if ([value isEqualToString:@"Oof"]) {	

		_showAs  = MSGraphService_FreeBusyStatus_Oof;
        [self valueChangedForInt:MSGraphService_FreeBusyStatus_Oof forProperty:@"ShowAs"];
	}

	if ([value isEqualToString:@"WorkingElsewhere"]) {	

		_showAs  = MSGraphService_FreeBusyStatus_WorkingElsewhere;
        [self valueChangedForInt:MSGraphService_FreeBusyStatus_WorkingElsewhere forProperty:@"ShowAs"];
	}

	if ([value isEqualToString:@"Unknown"]) {	

		_showAs  = MSGraphService_FreeBusyStatus_Unknown;
        [self valueChangedForInt:MSGraphService_FreeBusyStatus_Unknown forProperty:@"ShowAs"];
	}
}

- (void)setResponseStatus:(MSGraphServiceResponseStatus *) responseStatus {
...
- (void)setResponseRequested:(BOOL ) responseRequested {
	...
	if ([value isEqualToString:@"SingleInstance"]) {	
        ...
        [self valueChangedForInt:MSGraphService_EventType_SingleInstance forProperty:@"Type"];
	}

	if ([value isEqualToString:@"Occurrence"]) {	

		_type  = MSGraphService_EventType_Occurrence;
        [self valueChangedForInt:MSGraphService_EventType_Occurrence forProperty:@"Type"];
	}

	if ([value isEqualToString:@"Exception"]) {	

		_type  = MSGraphService_EventType_Exception;
        [self valueChangedForInt:MSGraphService_EventType_Exception forProperty:@"Type"];
	}

	if ([value isEqualToString:@"SeriesMaster"]) {	

		_type  = MSGraphService_EventType_SeriesMaster;
        [self valueChangedForInt:MSGraphService_EventType_SeriesMaster forProperty:@"Type"];
	}
}
...
- (void)setRecurrence:(MSGraphServicePatternedRecurrence *) recurrence {
    _recurrence = recurrence;
	[self valueChanged:recurrence forProperty:@"Recurrence"];
}
    
- (void)setOrganizer:(MSGraphServiceRecipient *) organizer {
